...
const hiDictionary = {
  ...
  about: {
    heading: "इस पोर्टल के बारे में",
    subheading: "विवेचक अधिकारियों के लिए प्रस्तुतीकरण-पूर्व प्रारूपण एवं सहयोग हेतु एक परत।",
    whatHeading: "यह क्या है",
    whatBody:
      "यह प्लेटफ़ॉर्म एक प्रस्तुतीकरण-पूर्व प्रारूपण एवं सहयोग परत है — एक कार्यक्षेत्र जहाँ अधिकारी केस-डायरी प्रविष्टियों को CCTNS में औपचारिक रूप से दर्ज करने से पहले तैयार और परिष्कृत करते हैं। यह न तो कोई आधिकारिक अभिलेख प्रणाली है और न ही इसे कभी CCTNS का विकल्प माना जाना चाहिए।",
    whyHeading: "यह क्यों बनाया गया",
    whyPoints: [
      "सीसीटीएनएस टर्मिनल स्थिर स्थानों पर होते हैं, जिससे मैदान में डायरी तैयार करने वाले अधिकारियों के लिए बाधाएं उत्पन्न होती हैं।",
      "अधिकारी वर्तमान में मैनुअल सीसीटीएनएस प्रविष्टि से पहले अनौपचारिक रूप से नोट्स तैयार करते हैं (कागज़, निजी उपकरण) — जिससे त्रुटियाँ, दोबारा काम और समय की हानि होती है।",
      "यह प्लेटफ़ॉर्म एक तेज़, कम-घर्षण वाले प्रारूपण स्थान के साथ इस अंतर को पाटता है जो आधिकारिक प्रस्तुतीकरण से पहले त्रुटियों को कम करता है।",
    ],
    ...
    aiHeading: "एआई-सहायता प्राप्त विवेचना",
    aiBody:
      "यह पोर्टल एआई-संचालित सुविधाओं से सुसज्जित है जो विवेचकों को विवेचना अधिक प्रभावी ढंग से करने में सहायता करने हेतु डिज़ाइन की गई हैं — समान पूर्व मामलों को सामने लाना और प्रारूपण में सहायता करना।",
    disclaimerHeading: "महत्वपूर्ण",
    disclaimerBody:
